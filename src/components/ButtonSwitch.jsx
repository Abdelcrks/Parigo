  ...
  return (
    ...
    <label className={`inline-block ${className}`}>
      <input
        ...
        role="switch"
      />
      <div className=" group flex w-fit cursor-pointer items-center gap-2 overflow-hidden border rounded-full bg-white border-pink-700 fill-none p-2 px-3 font-bold text-pink-500 transition-all active:scale-90 peer-checked:fill-pink-500 peer-checked:hover:text-white"      >
        <div className="z-10 transition group-hover:translate-x-4">Favoris</div>
